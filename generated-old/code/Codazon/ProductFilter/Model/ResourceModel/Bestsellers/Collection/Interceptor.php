<?php
namespace Codazon\ProductFilter\Model\ResourceModel\Bestsellers\Collection;

/**
 * Interceptor class for @see \Codazon\ProductFilter\Model\ResourceModel\Bestsellers\Collection
 */
class Interceptor extends \Codazon\ProductFilter\Model\ResourceModel\Bestsellers\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTableByAggregationPeriod');
        if (!$pluginInfo) {
            return parent::getTableByAggregationPeriod($period);
        } else {
            return $this->___callPlugins('getTableByAggregationPeriod', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_applyAggregatedTable');
        if (!$pluginInfo) {
            return parent::_applyAggregatedTable();
        } else {
            return $this->___callPlugins('_applyAggregatedTable', func_get_args(), $pluginInfo);
        }
    }
