<?php
namespace Jmango360\Japi\Model\Catalog\Category;

/**
 * Interceptor class for @see \Jmango360\Japi\Model\Catalog\Category
 */
class Interceptor extends \Jmango360\Japi\Model\Catalog\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Helper\PostHelper $postDataHelper, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Framework\ObjectManagerInterface $objectManagerInterface, \Magento\Framework\Module\Manager $moduleManager, \Magento\Customer\Model\Session $customerSession, \Magento\Catalog\Api\CategoryRepositoryInterface $categoryRepository, \Magento\Catalog\Api\ProductRepositoryInterface $productRepositoryInterface, \Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Helper\Category $categoryHelper, \Magento\Catalog\Model\Layer\Resolver $layerResolver, \Magento\Catalog\Model\Product $productModel, \Magento\Catalog\Model\Session $catalogSession, \Jmango360\Japi\Model\Catalog\Layer\FilterListFactory $filterListFactory, \Jmango360\Japi\Helper\Product $japiProductHelper, \Jmango360\Japi\Helper\Product\Configurable $japiConfigurableHelper, \Jmango360\Japi\Helper\Product\Bundle $japiBundleHelper, \Jmango360\Japi\Helper\Product\Grouped $japiGroupedHelper, \Jmango360\Japi\Model\Data\Catalog\ProductToolbarFactory $productToolbar, \Jmango360\Japi\Model\Data\Catalog\ProductToolbarOrderFactory $productToolbarOrder, \Jmango360\Japi\Model\Data\Catalog\ProductFactory $productFactory, \Jmango360\Japi\Model\Data\Product\ListItemFactory $listItemFactory, \Jmango360\Japi\Model\Data\Catalog\Product\ProductMediaFactory $productMediaFactory, \Jmango360\Japi\Model\Data\Catalog\ProductFilterFactory $productFilterFactory, \Jmango360\Japi\Model\Data\Catalog\ProductFilterItemFactory $productFilterItemFactory, \Jmango360\Japi\Model\Data\Product\ProductDetailsFactory $productDetailsFactory, \Jmango360\Japi\Helper\Common $commonHelper, array $data = [])
    {
        $this->___init();
        parent::__construct($postDataHelper, $urlHelper, $objectManagerInterface, $moduleManager, $customerSession, $categoryRepository, $productRepositoryInterface, $context, $categoryHelper, $layerResolver, $productModel, $catalogSession, $filterListFactory, $japiProductHelper, $japiConfigurableHelper, $japiBundleHelper, $japiGroupedHelper, $productToolbar, $productToolbarOrder, $productFactory, $listItemFactory, $productMediaFactory, $productFilterFactory, $productFilterItemFactory, $productDetailsFactory, $commonHelper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getToolbarInfo');
        if (!$pluginInfo) {
            return parent::getToolbarInfo();
        } else {
            return $this->___callPlugins('getToolbarInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsV2');
        if (!$pluginInfo) {
            return parent::getProductsV2();
        } else {
            return $this->___callPlugins('getProductsV2', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductV2');
        if (!$pluginInfo) {
            return parent::getProductV2($productId);
        } else {
            return $this->___callPlugins('getProductV2', func_get_args(), $pluginInfo);
        }
    }
