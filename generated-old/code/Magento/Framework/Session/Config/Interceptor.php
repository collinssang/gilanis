...
/**
 * Interceptor class for @see \Magento\Framework\Session\Config
 */
class Interceptor extends \Magento\Framework\Session\Config implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\ValidatorFactory $validatorFactory, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\Stdlib\StringUtils $stringHelper, \Magento\Framework\App\RequestInterface $request, \Magento\Framework\Filesystem $filesystem, \Magento\Framework\App\DeploymentConfig $deploymentConfig, $scopeType, $lifetimePath = 'web/cookie/cookie_lifetime')
    {
        $this->___init();
