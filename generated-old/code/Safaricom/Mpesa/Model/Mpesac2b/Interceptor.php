<?php
namespace Safaricom\Mpesa\Model\Mpesac2b;

/**
 * Interceptor class for @see \Safaricom\Mpesa\Model\Mpesac2b
 */
class Interceptor extends \Safaricom\Mpesa\Model\Mpesac2b implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPayPaybill');
        if (!$pluginInfo) {
            return parent::getPayPaybill();
        } else {
            return $this->___callPlugins('getPayPaybill', func_get_args(), $pluginInfo);
        }
    }
