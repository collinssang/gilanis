<?php
namespace Vsourz\HotDeals\Block\Widget\HotCategory;

/**
 * Interceptor class for @see \Vsourz\HotDeals\Block\Widget\HotCategory
 */
class Interceptor extends \Vsourz\HotDeals\Block\Widget\HotCategory implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Rule\Model\Condition\Sql\Builder $sqlBuilder, \Magento\CatalogWidget\Model\Rule $rule, \Magento\Widget\Helper\Conditions $conditionsHelper, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Magento\Catalog\Model\ResourceModel\Product\Collection $collection, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productCollectionFactory, $catalogProductVisibility, $httpContext, $sqlBuilder, $rule, $conditionsHelper, $categoryFactory, $collection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsAllCollection');
        if (!$pluginInfo) {
            return parent::getProductsAllCollection();
        } else {
            return $this->___callPlugins('getProductsAllCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryFactory');
        if (!$pluginInfo) {
            return parent::getCategoryFactory();
        } else {
            return $this->___callPlugins('getCategoryFactory', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryCollections');
        if (!$pluginInfo) {
            return parent::getCategoryCollections();
        } else {
            return $this->___callPlugins('getCategoryCollections', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSpecialPrice($_product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSpecialPrice($_product);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNormalPrice');
        if (!$pluginInfo) {
            return parent::getNormalPrice($_product);
        } else {
            return $this->___callPlugins('getNormalPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSavedAmount');
        if (!$pluginInfo) {
            return parent::getSavedAmount($_product);
        } else {
            return $this->___callPlugins('getSavedAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDiscountPercent($_product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getDiscountPercent($_product);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryCollectionFactory');
        if (!$pluginInfo) {
            return parent::getCategoryCollectionFactory();
        } else {
            return $this->___callPlugins('getCategoryCollectionFactory', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryCollectionByIds');
        if (!$pluginInfo) {
            return parent::getCategoryCollectionByIds();
        } else {
            return $this->___callPlugins('getCategoryCollectionByIds', func_get_args(), $pluginInfo);
        }
    }
